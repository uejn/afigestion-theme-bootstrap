<?php
$this->set('title_for_layout', __d('croogo', 'Recuperar contraseña'));
?>
<style>
...
<div class="afi-recuperar-wrapper">
	<div class="afi-recuperar-card">
		...
		<h2><?php echo __d('croogo', '¿Olvidaste tu contraseña?'); ?></h2>
		<p class="afi-sub"><?php echo __d('croogo', 'Ingresá tu nombre de usuario y te enviaremos un correo con las instrucciones para restablecerla.'); ?></p>

		<?php echo $this->Form->create('User', array(
			'url' => array('controller' => 'users', 'action' => 'forgot'),
			'inputDefaults' => array('div' => false, 'label' => false),
		)); ?>
			<div class="afi-input-group">
				<label for="UserUsername"><?php echo __d('croogo', 'Usuario'); ?></label>
				<?php echo $this->Form->text('username', array(
					'id' => 'UserUsername',
					'placeholder' => __d('croogo', 'Ingresá tu usuario'),
					'autofocus' => true,
					'required' => true,
				)); ?>
			</div>
			<button type="submit" class="afi-btn"><?php echo __d('croogo', 'Enviar instrucciones'); ?></button>
